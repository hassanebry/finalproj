 ...
 */
final class Version20200405232337 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conducteur (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, num_permi VARCHAR(255) DEFAULT NULL, voiture VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_23677143FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
